export default function Sobre(){
    return (
        <>
            ...
            <aside>
                <h2>Sobre Nos</h2>
                <p>WorkFacil é uma plataforma web projetada para conectar empresas e freelancers de diversas áreas com facilidade. Com nossa interface intuitiva e funcionalidade de busca avançada, você pode:</p>
                <ul>
